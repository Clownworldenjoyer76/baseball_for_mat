...
def main():
    ...
    batters_df = pd.read_csv(batter_input).rename(columns={"last_name, first_name": "name"})
    pitchers_df = pd.read_csv(pitcher_input).rename(columns={"last_name, first_name": "name"})
